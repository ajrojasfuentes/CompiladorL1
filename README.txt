...
2. Compile el programa con el siguiente comando: javac -cp . CompiladorL1/*.java
...
3. Una vez compilado, ejecute el programa con el siguiente comando (reemplazando la ruta del archivo con la ubicación de su archivo de entrada):
   java -cp . CompiladorL1.src.main.miCompilador "ruta a su archivo.txt"

Ejemplo:
   java -cp . CompiladorL1.src.main.miCompilador "C:\Users\Vale\Documents\TEC\IIS 2024\Compi\ProyectoCompi\Proyecto1_AnalisisLexico_Subgrupo 1_IIS2024\lexCorrecto1.txt"
